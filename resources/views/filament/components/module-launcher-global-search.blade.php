...
<div class="module-launcher-global-search fi-global-search-ctn">
    <div
    ...
    >
        <div x-id="['input']" class="fi-global-search-field">
            <label x-bind:for="$id('input')" class="fi-sr-only">
                {{ __('module-launcher.search.label') }}
            </label>
            ...
            >
                <input
                    autocomplete="off"
                    maxlength="1000"
                    placeholder="{{ __('module-launcher.search.placeholder') }}"
                    type="search"
                    wire:key="module-launcher-global-search.field.input"
                    x-bind:id="$id('input')"
                    x-on:keydown.down.prevent.stop="$dispatch('focus-first-global-search-result')"
                    x-on:input="$dispatch('module-launcher-filter', { query: $event.target.value })"
                    ...
                    class="fi-input fi-input-has-inline-prefix module-launcher-global-search__input"
                />
            </x-filament::input.wrapper>
        </div>
        ...
        @if ($results !== null)
            <div
                ...
                class="fi-global-search-results-ctn module-launcher-global-search__results"
            >
