...
class DueSoonBorrowingsWidget extends BaseWidget
{
    ...
    {
        return __('assets-extensions::dashboard.due_soon');
    }
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->emptyStateHeading(__('assets-extensions::dashboard.no_due_soon'))
            ->paginated(false);
    }
}
