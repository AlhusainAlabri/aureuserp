...
class BorrowingRequestSubmittedMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: __('assets-extensions::mail.submitted.subject', [
    ...
    {
        return new Content(
            markdown: 'mail.assets.borrowing-request-submitted',
            with: [
