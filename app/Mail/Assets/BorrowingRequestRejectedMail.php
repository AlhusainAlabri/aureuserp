...
class BorrowingRequestRejectedMail extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: __('assets-extensions::mail.rejected.subject', [
    ...
    {
        return new Content(
            markdown: 'mail.assets.borrowing-request-rejected',
            with: [
